...
public class LeoStreamData {
    ...
    public LeoChannel getChannel() {
        return this.channel;
    }

    public void setChannel(LeoChannel channel) {
